...
public:
    ...
    void insertarAlFinal( const char & );
    bool eliminarDelFinal( char & );
    void imprimir() const;
    
    // funciÛn utilitaria para asignar un nuevo nodo
    
    Nodo *obtenerNuevoNodo( const char & );
...
void Lista::insertarAlFinal( const char &nombre )
{
...
bool Lista::eliminarDelFinal( char nombre[] )
{
...
Nodo *Lista::obtenerNuevoNodo( const char nombre[] )
{
...
void probarLista( Lista &objetoLista )
{
    ...
    char Nombre[50]; // almacena el valor de entrada
